  ...
  class TerraformObjectLibrary < Provider::Terraform
    ...
    def copy_common_files(output_folder, generate_code, _generate_docs)
      ...
      copy_file_list(output_folder, [
                       ...
                       ['google/cloudfunctions_function_iam.go',
                        'third_party/validator/cloudfunctions_function_iam.go'],
                       ['google/bigquery_table_iam.go',
                        'third_party/validator/bigquery_table_iam.go'],
                       ['google/bigquery_dataset_iam.go',
                        'third_party/validator/bigquery_dataset_iam.go'],
                       ['google/bigtable_table_iam.go',
                        'third_party/validator/bigtable_table_iam.go'],
                       ['google/bigtable_instance_iam.go',
                        'third_party/validator/bigtable_instance_iam.go'],
                       ['google/pubsub_subscription_iam.go',
                        'third_party/validator/pubsub_subscription_iam.go'],
                       ['google/pubsub_topic_iam.go',
                        'third_party/validator/pubsub_topic_iam.go'],
